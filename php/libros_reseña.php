...
//require_once('../php/save_stars.php');
$JSON = readJSON(LIBROS_DATA_FILE);
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <table >
              ...
              <tr>
                <th>Editorial:</th>
                 <td><?php echo $review['editorial'] ?> </td>
              </tr>
              <tr>
                <th>Categoría:</th>
        ...
        <div class="container mt-3">
          <div class="media border p-3">
            ...
            <form action="../php_principales/comments_form_process.php" method="POST">
                <input type="hidden" id="categoria" name="categoria" value="libros">
