...
$JSON = readJSON(PELICULAS_DATA_FILE);
    ...
    <section>
      <article class="principal">
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <!-- Botón para suscriptores (Calificar reseña) -->
          <!--  <button class="btn btn-primary" type="submit">Calificar Reseña</button>
          -->
            <table >
              <tr>
                <th>Título:</th>
              ...
              <tr>
                <th>Director:</th>
                 <td><?php echo $review['director'] ?> </td>
              </tr>
              <tr>
                <th>Estreno:</th>
                 <td><?php echo $review['estreno'] ?> </td>
              </tr>
              <tr>
                <th>Clasificación:</th>
                 <td><?php echo $review['clasificacion'] ?> </td>
              </tr>
              <tr>
                <th>Género:</th>
        ...
        <div class="container mt-3">
          <div class="media border p-3">
            ...
            <form action="../php_principales/comments_form_process.php" method="POST">
                <input type="hidden" id="categoria" name="categoria" value="peliculas">
      ...
      <!-- Botón para suscriptores (Añadir comentarios) -->
      <!--<button class="btn btn-primary" type="submit">Añadir Comentario</button>
      -->
